...
class Statistics(
    ...
    override fun drawElement(partialTicks: Float): Border {
        val height = (FontLoaders.F22.getStringHeight("Statistics") + 14.0f + 41.0F) / 2.0f // 计算新的高度
        ...
        GL11.glPushMatrix()
        GL11.glTranslated(0.0, (FontLoaders.F22.getStringHeight("Statistics") + 14.0f.toDouble()) / 2.0, 0.0)
        ...
        return Border(0f, 0f, 140f, height.toFloat())
    }
}
