    ...
    fun drawBtns() {
        ...
        this.buttonList.add(
            TestBtn(
                ...
                if (LiquidBounce.Darkmode.equals(true)) { ResourceLocation("leaf/imgs/icon/quitDark.png") } else { ResourceLocation("leaf/imgs/icon/quit.png") },
                2,
                if (LiquidBounce.Darkmode.equals(true)) { Color(20, 20, 20, 180) } else { Color(255, 255, 255, 170) }
            )
        )
        ...
        this.buttonList.add(
            TestBtn(
                ...
                if (LiquidBounce.Darkmode.equals(true)) { ResourceLocation("leaf/imgs/icon/settingDark.png") } else { ResourceLocation("leaf/imgs/icon/setting.png") },
                2,
                if (LiquidBounce.Darkmode.equals(true)) { Color(20, 20, 20, 180) } else { Color(255, 255, 255, 170) }
                )
        )
        ...
        this.buttonList.add(
            TestBtn(
                ...
                if (LiquidBounce.Darkmode.equals(true)) { ResourceLocation("leaf/imgs/icon/wallpaperDark.png") } else { ResourceLocation("leaf/imgs/icon/wallpaper.png") },
                2,
                if (LiquidBounce.Darkmode.equals(true)) { Color(20, 20, 20, 180) } else { Color(255, 255, 255, 170) }
            )
        )
            ...
            TestBtn(
                ...
                25,
                "Website",
                if (LiquidBounce.Darkmode.equals(true)) { ResourceLocation("leaf/imgs/icon/websiteDark.png") } else { ResourceLocation("leaf/imgs/icon/website.png") },
                2,
                if (LiquidBounce.Darkmode.equals(true)) { Color(20, 20, 20, 180) } else { Color(255, 255, 255, 170) }
            )
        )
        ...
        this.buttonList.add(
            TestBtn(
                203, this.width - 155, 10, 25, 25, "Discord", if (LiquidBounce.Darkmode.equals(true)) { ResourceLocation("leaf/imgs/icon/discordDark.png") } else { ResourceLocation("leaf/imgs/icon/discord.png") }, 2,
                if (LiquidBounce.Darkmode.equals(true)) { Color(20, 20, 20, 180) } else { Color(255, 255, 255, 170) }
            )
        )
        ...
        this.buttonList.add(
            TestBtn(
                205, 20, 10, 25, 25, "Toggle theme", if (LiquidBounce.Darkmode.equals(true)) { ResourceLocation("leaf/imgs/icon/moon-nightDark.png") } else { ResourceLocation("leaf/imgs/icon/moon-night.png") }, 2,
                if (LiquidBounce.Darkmode.equals(true)) { Color(20, 20, 20, 180) } else { Color(255, 255, 255, 170) }
            )
        )
