package net.nonemc.leaf.launch.data.modernui.mainmenu.gui;
...
import static net.nonemc.leaf.launch.data.modernui.mainmenu.config.ButtonConfigsKt.updateButtonConfig;
