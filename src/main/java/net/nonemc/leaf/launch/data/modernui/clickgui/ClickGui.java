...
import net.nonemc.leaf.launch.data.modernui.clickgui.elements.Element;
...
import net.nonemc.leaf.launch.data.modernui.clickgui.style.styles.SlowlyStyle;
import net.nonemc.leaf.launch.options.modernuiLaunchOption;
import net.nonemc.leaf.ui.client.hud.designer.GuiHudDesigner;
import net.nonemc.leaf.ui.font.AWTFontRenderer;
...
public class ClickGui extends GuiScreen {
    ...
    public void onGuiClosed() {
        Leaf.fileManager.saveConfig(modernuiLaunchOption.getClickGuiConfig());
    }
