...
public class NullStyle extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        RenderUtils.drawGradientSidewaysH((float) panel.getX() - 3, (float) panel.getY(), (float) panel.getX() + panel.getWidth() + 3, (float) panel.getY() + 19, ClickGUIModule.generateColor().getRGB(), ColorUtils.reAlpha(ClickGUIModule.generateColor(), 50).getRGB());
        if (panel.getFade() > 0)
