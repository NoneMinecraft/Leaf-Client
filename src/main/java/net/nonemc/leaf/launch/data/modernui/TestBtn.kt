...
class TestBtn : GuiButton {
    ...
    override fun drawButton(mc: Minecraft, mouseX: Int, mouseY: Int) {
        ...
        RenderUtils.drawRoundedCornerRect(
            ...
            if (Leaf.Darkmode) Color(255, 255, 255, 30).rgb else Color(0, 0, 0, 70).rgb
        )
        RenderUtils.drawRoundedCornerRect(
            ...
            if (Leaf.Darkmode) Color(255, 255, 255, 110 + (wi * 10)).rgb else Color(0, 0, 0, 120 + (wi * 10)).rgb
        )
        RenderUtils.drawRoundedCornerRect(
            xPosition.toFloat(),
            ...
            if (image != null) width.toFloat() / 2 else 3f,
            if (Leaf.Darkmode) Color(255, 255, 255, 80).rgb else Color(0, 0, 0, 50).rgb
        )
        ...
        if (image != null) {
            if (this.isMouseOver) {
                ...
                RenderUtils.drawRoundedCornerRect(
                    ...
                    3f,
                    if (Leaf.Darkmode) Color(255, 255, 255, (150 * percent).toInt()).rgb else Color(
                        0,
                        0,
                        0,
                        (150 * percent).toInt()
                ...
                FontLoaders.C16.DisplayFonts(
                    ...
                    if (Leaf.Darkmode) Color(50, 50, 50, (254 * percent).toInt()).rgb else Color(
                        180,
                        180,
                        180,
                        (254 * percent).toInt()
            ...
            font.DisplayFonts(
                ...
                if (Leaf.Darkmode) Color(50, 50, 50, 255).rgb else Color(180, 180, 180, 255).rgb,
                FontLoaders.C16
            )
        }
        GL11.glPopAttrib()
