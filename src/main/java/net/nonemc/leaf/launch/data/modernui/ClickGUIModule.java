...
import net.nonemc.leaf.launch.data.modernui.clickgui.style.styles.Slight.SlightUI;
import net.nonemc.leaf.launch.data.modernui.clickgui.style.styles.dropdown.DropdownGUI;
import net.nonemc.leaf.launch.data.modernui.clickgui.style.styles.light.LightClickGUI;
import net.nonemc.leaf.launch.data.modernui.clickgui.style.styles.novoline.ClickyUI;
...
public class ClickGUIModule extends Module {
    public static final BoolValue backback = new BoolValue("Background Accent", true);    private final ListValue styleValue = new ListValue("Style", new String[]{"Better", "Classic", "Light", "Novoline", "Astolfo", "LiquidBounce", "Null", "Slowly", "Black", "White"}, "Classic") {
        @Override
    ...
    public static boolean isLight() {
        return clickguicolormode.get().equalsIgnoreCase("White");
    }
    ...
    private void updateStyle() {
        switch (styleValue.get().toLowerCase()) {
            case "leaf":
                ...
                break;
            case "better":
                modernuiLaunchOption.clickGui.style = new SlightUI();
                break;
            case "null":
