...
public class TTFFontRenderer {
    ...
    private CharacterData[] setup(CharacterData[] characterData, int type) {
        ...
        for (int index = 0; index < characterData.length; index++) {
            ...
            // The ai that the character will be rendered to.
            ...
            // The graphics of the character ai.
            ...
            // Fills the entire ai with the color above, makes it transparent.
     ...
     * @param image     The ai to upload.
     */
    private void createTexture(int textureId, BufferedImage image) {
        // Array of all the colors in the ai.
        int[] pixels = new int[image.getWidth() * image.getHeight()];

        // Fetches all the colors in the ai.
