...
import net.nonemc.leaf.launch.data.modernui.clickgui.style.styles.tenacity.impl.ModuleRect;
...
import net.nonemc.leaf.launch.data.modernui.clickgui.utils.normal.Screen;
...
import static net.nonemc.leaf.launch.data.modernui.clickgui.utils.render.DrRenderUtils.isHovering;
...
public class MainScreen implements Screen {
    ...
    public void initGui() {
        if (moduleRects == null) {
            ...
            for (Module module : Main.getModulesInCategory(category, Leaf.moduleManager).stream().sorted(Comparator.comparing(Module::getName)).collect(Collectors.toList())) {
