...
import net.nonemc.leaf.launch.data.modernui.TestBtn
...
class rebornGuiMainMenu : GuiScreen(), GuiYesNoCallback {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        FontLoaders.F16.drawString(
            Leaf.CLIENT_NAME + " by SkidderMC",
            10f,
            this.height - 15f,
            Color(1, 1, 1, 170).rgb
        )
        var versionMsg =
            "Version: " + Leaf.CLIENT_VERSION
        FontLoaders.F16.drawString(
            versionMsg,
    ...
    override fun actionPerformed(button: GuiButton) {
        when (button.id) {
            ...
            203 -> MiscUtils.showURL("https://${Leaf.CLIENT_WEBSITE}/discord.html")
            204 -> MiscUtils.showURL("https://${Leaf.CLIENT_WEBSITE}")
            205 -> Leaf.Darkmode = !Leaf.Darkmode
        }
    }
