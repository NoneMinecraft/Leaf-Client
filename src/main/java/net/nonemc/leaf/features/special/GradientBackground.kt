...
object GradientBackground {
    ...
    init {
        ...
        val json = JsonParser().parse(
            GradientBackground::class.java.classLoader.getResourceAsStream("assets/minecraft/leaf/ui/misc/gradient.json")!!
    ...
    fun draw(width: Int, height: Int) {
        if (!animated) {
            ...
            when (gradientSide) {
                GradientSide.LEFT -> RenderUtils.drawGradientSidewaysH(
                    0.0,
                    0.0,
                    width.toDouble(),
                    height.toDouble(),
                ...
                GradientSide.RIGHT -> RenderUtils.drawGradientSidewaysH(
                    0.0,
                    0.0,
                    width.toDouble(),
                    height.toDouble(),
                ...
                GradientSide.TOP -> RenderUtils.drawGradientSidewaysV(
                    0.0,
                    0.0,
                    width.toDouble(),
                    height.toDouble(),
                ...
                GradientSide.BOTTOM -> RenderUtils.drawGradientSidewaysV(
                    0.0,
                    0.0,
                    width.toDouble(),
                    height.toDouble(),
