                ...
                mc.thePlayer.onGround -> {
                    if (groundTick >= groundStay.get()) {
                        ...
                        if (doLaunchSpeedValue.get() && strafeBeforeJump.get()) {
                            EntityMoveLib.strafe(launchSpeedValue.get())
                        }
                        if (doJump.get()) {
                            mc.thePlayer.jump()
                        } else {
                    ...
                    if (doMinimumSpeedValue.get() && EntityMoveLib.getSpeed() < minimumSpeedValue.get()) {
                        EntityMoveLib.strafe(minimumSpeedValue.get())
                    }
                    when (strafeValue.get().lowercase()) {
                        "strafe" -> EntityMoveLib.strafe(speedValue.get())
                        "non-strafe" -> EntityMoveLib.strafe()
                        "boost" -> EntityMoveLib.strafe()
                        "airspeed" -> {
                        ...
                        "plus" -> {
                            when (plusMode.get().lowercase()) {
                                "plus" -> EntityMoveLib.move(speedValue.get() * 0.1f)
                                "multiply" -> {
