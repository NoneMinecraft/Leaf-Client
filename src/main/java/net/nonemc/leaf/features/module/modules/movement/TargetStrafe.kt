...
import net.nonemc.leaf.utils.render.ColorManager
...
class TargetStrafe : Module() {
    ...
    fun toggleStrafe(): Boolean {
        return targetEntity != null && (!holdSpaceValue.get() || mc.thePlayer.movementInput.jump) && (!onlySpeedValue.get() || Leaf.moduleManager[Speed::class.java]!!.state)
    }
