...
import net.nonemc.leaf.data.PlaceRotation
import net.nonemc.leaf.data.Rotation
import net.nonemc.leaf.data.VecRotation
...
import net.nonemc.leaf.utils.inventory.InventoryUtils.BLOCK_BLACKLIST
...
import net.nonemc.leaf.utils.rotation.RotationUtils.getAngleDifference
import net.nonemc.leaf.utils.rotation.RotationUtils.getRotationDifference
import net.nonemc.leaf.utils.block.BlockUtils
import net.nonemc.leaf.utils.block.BlockUtils.isReplaceable
import net.nonemc.leaf.utils.block.PlaceInfo
import net.nonemc.leaf.utils.block.PlaceInfo.Companion.get
import net.nonemc.leaf.utils.extensions.drawCenteredString
import net.nonemc.leaf.utils.extensions.rayTraceWithServerSideRotation
    ...
    fun onMotion(event: MotionEvent) {
        ...
        if (rotationsValue.get() != "None" && keepLengthValue.get() > 0 && lockRotation != null && silentRotationValue.get()) {
            if (rotationsValue.equals("BackSnap")) {
                ...
                val limitedRotation = limitAngleChange(RotationUtils.serverRotation, lockRotation!!, rotationSpeed)
    ...
    private fun search(blockPosition: BlockPos, checks: Boolean): Boolean {
        ...
        if (!towerrotationsValue.equals("None") && towerStatus) {
            ...
            if (silentRotationValue.get()) {
                val limitedRotation =
                    limitAngleChange(RotationUtils.serverRotation, lockRotation!!, rotationSpeed)
                RotationUtils.setTargetRotation(limitedRotation, keepLengthValue.get())
            } else {
