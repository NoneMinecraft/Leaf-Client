...
class Fly : Module() {
    private val modes = ClassReflect.resolvePackage("${this.javaClass.`package`.name}.flys", FlyMode::class.java)
    ...
    override fun onDisable() {
        ...
        if (motionResetValue.get() && needReset) EntityMoveLib.resetMotion(true)
