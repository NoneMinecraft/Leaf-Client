...
class CommandGUI(private val module: CMD) : GuiScreen() {
    ...
    override fun initGui() {
        ...
        // Initialize input field with saved state
        inputField = GuiTextField(0, mc.fontRendererObj,
            left + 2,
            top + guiHeight - 20,
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        if (outputLines.size > maxVisibleLines) {
            ...
            scrollBarY = (top + 5 + (scrollOffset.toFloat() / (outputLines.size - maxVisibleLines)) * scrollRange).toInt()
