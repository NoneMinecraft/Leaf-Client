...
class Criticals : Module() {
    //90% DCJ Mode 0% Bypass
    private val Mode = ListValue("Mode", arrayOf("C04", "Motion","LegitJump","FastPos","SetPos","FastMotion","Packet","More","Double","PreDouble","Smart","NoGround"), "C04")
