...
import net.nonemc.leaf.utils.ClientUtils.displayChatMessage
import net.nonemc.leaf.utils.extensions.getFullName
...
//                alert("NOCLIP[${cb.size}] ${entity.displayName.unformattedText} ${entity.posX} ${entity.posY} ${entity.posZ}")
    ...
    fun onPacket(event: PacketEvent) {
        ...
        if (packet is S18PacketEntityTeleport) {
            ...
            if (Leaf.combatManager.inCombat && !hasRemovedEntities.contains(packet.entityID)) {
