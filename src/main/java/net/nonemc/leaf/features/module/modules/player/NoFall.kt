...
class NoFall : Module() {
    private val modes = ClassReflect.resolvePackage("${this.javaClass.`package`.name}.nofalls", NoFallMode::class.java)
    ...
    fun onUpdate(event: UpdateEvent) {
        ...
        if (BlockLib.collideBlock(mc.thePlayer.entityBoundingBox) { it is BlockLiquid } || BlockLib.collideBlock(
                AxisAlignedBB(
