package net.nonemc.leaf.libs.rotation;
...
public final class RotationBaseLib extends MinecraftInstance implements Listenable {
    ...
    public static void setTargetRotation(final Rotation rotation, final int keepLength) {
        ...
        RotationBaseLib.keepLength = keepLength;
        RotationBaseLib.revTick = 0;
    }
    ...
    public static Rotation toRotation(final Vec3 vec) {
