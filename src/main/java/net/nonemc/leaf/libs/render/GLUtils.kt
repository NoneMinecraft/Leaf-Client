...
import net.nonemc.leaf.libs.render.shader.shaders.SRoundRectShader
...
object GLUtils {
    ...
    fun drawImage(image: ResourceLocation, x: Int, y: Int, width: Int, height: Int) {
        ...
        net.nonemc.leaf.libs.base.mc.textureManager.bindTexture(image)
    ...
    fun interpolate(old: Double, current: Double): Double {
        return old + (current - old) * net.nonemc.leaf.libs.base.mc.timer.renderPartialTicks.toDouble()
    }
