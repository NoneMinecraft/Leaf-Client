    ...
    override fun drawElement(partialTicks: Float): Border {
        ...
        if (rectShadow.get()) {
            ...
            RenderUtils.drawRect(
                ...
                140f,
                height,
                Color(rectR.get(), rectG.get(), rectB.get(), rectAlpha.get()).rgb
            )
        } else {
        ...
        FontLoaders.F22.drawCenteredString(
            ...
            (140f / 2f).toDouble(),
            5.0,
            Color(255, 255, 255, textAlpha.get()).rgb
        )
        ...
        FontLoaders.C16.drawString(
            mc.thePlayer.name,
            135F - FontLoaders.C16.getStringWidth(mc.thePlayer.name),
            0.0f,
            Color(255, 255, 255, textAlpha.get()).rgb
        )
        ...
        else FontLoaders.C16.drawString(
            "Singleplayer",
            135F - FontLoaders.C16.getStringWidth("Singleplayer"),
            10.0f,
            Color(255, 255, 255, 180).rgb
        )
