package net.nonemc.leaf.ui.clickgui.style.styles.dropdown;

import net.nonemc.leaf.Leaf;
import net.nonemc.leaf.features.module.ModuleCategory;
import net.nonemc.leaf.libs.render.RenderUtils;
import net.nonemc.leaf.ui.clickgui.fonts.impl.Fonts;
...
public class Tab {
    ...
    public Tab(ModuleCategory enumModuleType, float posX, float posY) {
        ...
        this.posX = posX;
        this.posY = posY;
        for (net.nonemc.leaf.features.module.Module abstractModule : Leaf.moduleManager.getModuleInCategory(enumModuleType)) {
