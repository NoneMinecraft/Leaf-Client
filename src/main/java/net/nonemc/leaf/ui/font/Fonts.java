...
import net.nonemc.leaf.utils.FileUtils;
...
public class Fonts {
    ...
    public static void loadFonts() {
        ...
        try {
            ...
            final File fontsFile = new File(Leaf.fileManager.getFontsDir(), "fonts.json");
    ...
    private static void initFonts() {
        try {
            initSingleFont("regular.ttf","assets/minecraft/leaf/font/regular.ttf");
        }catch(IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private static Font getFont1(int size) {
        ...
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager()
                    .getResource(new ResourceLocation("leaf/font/icon.ttf")).getInputStream();
            font = Font.createFont(0, is);
            font = font.deriveFont(0, size);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private static Font getFont2(int size) {
        ...
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager()
                    .getResource(new ResourceLocation("leaf/font/regular.ttf")).getInputStream();
            font = Font.createFont(0, is);
            font = font.deriveFont(0, size);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private static Font getFont3(int size) {
        ...
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager()
                    .getResource(new ResourceLocation("leaf/icons/SFBOLD.ttf")).getInputStream();
            font = Font.createFont(0, is);
            font = font.deriveFont(0, size);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private static void initSingleFont(String name, String resourcePath) throws IOException {
        File file=new File(Leaf.fileManager.getFontsDir(), name);
        if(!file.exists())
    ...
    private static Font getFont(final String fontName, final int size) {
        try {
            final InputStream inputStream = new FileInputStream(new File(Leaf.fileManager.getFontsDir(), fontName));
