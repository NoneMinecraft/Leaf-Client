...
import net.nonemc.leaf.file.capesDir
...
object GuiCapeManager : GuiScreen() {
    private val jsonFile = File(capesDir, "cape.json")
    ...
    fun load() {
        ...
        for (file in capesDir.listFiles()) {
    ...
    fun save() {
        ...
        jsonFile.writeText(FileConfigManager.PRETTY_GSON.toJson(json), Charsets.UTF_8)
    }
